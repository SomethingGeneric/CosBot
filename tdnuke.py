# CONFIG
# ---------
token = "mfa.YHZ7J1V78xrlVjgy0UXf06TwoPXfBy6S3K1HuVMUxepRuNavIrqAAKGioUCg32pyiSPDh9_o01k4Pl2ksjEr" # To find this, press CTRL + SHIFT + i in the Discord client revealing the inspect element prompt. Click the arrows, head over to Application, local storage and there you can find your user token :)
prefix = "td" # This will be used at the start of commands.
rename_to = "КРЪВЪТ НА НАШАТА КОУПРИЯТИЯ ВЪЗПОМНЯВА ВСИЧКИ МАГИЯ" # The string everyone possible will be renamed to using the 'rall' command.
# ----------
